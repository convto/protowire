...
func readTag(b []byte) (fn uint32, wt wireType, n int, err error) {
...
func readValue(st structTag, rv reflect.Value, wt wireType, b []byte) (n int, err error) {
	if wt != st.wt {
