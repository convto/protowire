...
type TestOneOf struct {
	...
	// Types that are assignable to TestIdentifier:
	//	*TestOneOf_Id
	//	*TestOneOf_Email
	TestIdentifier isTestOneOf_TestIdentifier `protobuf_oneof:"TestIdentifier"`
	// Types that are assignable to TestMessage:
	//	*TestOneOf_TextMessage
	//	*TestOneOf_BinaryMessage
	TestMessage isTestOneOf_TestMessage `protobuf_oneof:"TestMessage"`
}
...
func (x *TestOneOf) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (m *TestOneOf) GetTestIdentifier() isTestOneOf_TestIdentifier {
	if m != nil {
		return m.TestIdentifier
	}
	return nil
}

func (x *TestOneOf) GetId() string {
	if x, ok := x.GetTestIdentifier().(*TestOneOf_Id); ok {
		return x.Id
	}
	return ""
}

func (x *TestOneOf) GetEmail() string {
	if x, ok := x.GetTestIdentifier().(*TestOneOf_Email); ok {
		return x.Email
	}
	return ""
}

func (m *TestOneOf) GetTestMessage() isTestOneOf_TestMessage {
	if m != nil {
...
func (x *TestOneOf) GetTextMessage() string {
	if x, ok := x.GetTestMessage().(*TestOneOf_TextMessage); ok {
		return x.TextMessage
	}
	return ""
}

func (x *TestOneOf) GetBinaryMessage() []byte {
	if x, ok := x.GetTestMessage().(*TestOneOf_BinaryMessage); ok {
...
func (*TestOneOf_Id) isTestOneOf_TestIdentifier() {}

func (*TestOneOf_Email) isTestOneOf_TestIdentifier() {}

type isTestOneOf_TestMessage interface {
	isTestOneOf_TestMessage()
}

type TestOneOf_TextMessage struct {
	TextMessage string `protobuf:"bytes,4,opt,name=text_message,json=textMessage,proto3,oneof"`
}

type TestOneOf_BinaryMessage struct {
	BinaryMessage []byte `protobuf:"bytes,5,opt,name=binary_message,json=binaryMessage,proto3,oneof"`
}

func (*TestOneOf_TextMessage) isTestOneOf_TestMessage() {}

func (*TestOneOf_BinaryMessage) isTestOneOf_TestMessage() {}
...
var file_proto_test_proto_rawDesc = []byte{
	...
	,
...
var file_proto_test_proto_goTypes = []interface{}{
	...
	(*TestOneOf)(nil),           // 7: testdata.TestOneOf
}
...
func file_proto_test_proto_init() {
	...
	file_proto_test_proto_msgTypes[7].OneofWrappers = []interface{}{
		(*TestOneOf_Id)(nil),
		(*TestOneOf_Email)(nil),
		(*TestOneOf_TextMessage)(nil),
		(*TestOneOf_BinaryMessage)(nil),
	}
	type x struct{}
